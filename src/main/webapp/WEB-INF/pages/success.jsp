	...
	<div class="container">
		<h2>Login Successful!! </h2>
			<div class="container-img">
					<img src="images/success.jpeg" width="400" height="300" alt="login success">
			</div>
		<h4>Congratulations Mr/Ms ${sdto.firstname} ${sdto.lastname} Your record is printed below!</h4>
		<br>
		<table class="styled-table">
			...
			<tbody>
				<tr>
					...
					<td>${sdto.email}</td>
					<td>${sdto.password}</td>
					<td><a href="updateUser?studentid=${sdto.studentid}">
		...
		<div>	
			...
			<a href="admin"><button class="button">Admin Login</button></a>
